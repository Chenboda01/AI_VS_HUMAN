...
class AIPlayer {
    ...
    adaptStrategy(aiState, humanState, currentTurn, maxTurns) {
        ...
        const humanHealthRatio = humanState.health / 100;
        const knowledgeRatio = this.knowledge / 50;
    ...
    selectStrategy() {
        const total = this.strategyWeights.answer + this.strategyWeights.attack + this.strategyWeights.defend;
